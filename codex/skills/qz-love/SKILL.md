---
name: qz-love
description: Use this skill for 七政四余 relationship, marriage, romance, 桃花, compatibility, breakup, reunion, partner traits, and timing questions after qz-reader and qz-core have produced qz_structured_data.md and qz_core_report.md.
---
...
感情、婚姻、桃花、合盘专题。本 Skill 输出以中文为主，所有结论都要区分“教材明确内容”“整理后的分析框架”“模型推理”“不确定项”。
...
- `resources/love_framework.md`
- `resources/relationship_palace_rules.md`
- `resources/compatibility_rules.md`
- `resources/cautious_language.md`
