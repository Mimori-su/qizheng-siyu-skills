---
name: qz-reader
description: Use this skill when the user provides a 七政四余 chart, PDF, screenshot, or pasted chart text and wants the chart data extracted, validated, and converted into qz_structured_data.md. This skill reads data only and does not perform fortune interpretation.
---
...
七政四余盘面数据入口，只提取和校验。本 Skill 输出以中文为主，所有结论都要区分“教材明确内容”“整理后的分析框架”“模型推理”“不确定项”。
