---
name: qz-rectifier
description: Use this skill when the user is unsure of birth time, wants 生时校正, compares candidate 时辰, or asks which birth time fits life events. It compares candidate charts and never claims perfect certainty.
---
...
生时校正专题。本 Skill 输出以中文为主，所有结论都要区分“教材明确内容”“整理后的分析框架”“模型推理”“不确定项”。
...
- `resources/birth_time_rectification.md`
- `resources/event_collection_form.md`
- `resources/event_mapping_rules.md`
- `resources/rectification_report_rules.md`
