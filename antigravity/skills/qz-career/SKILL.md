---
name: qz-career
description: Use this skill for 七政四余 career, 官禄, job, reputation, promotion, profession direction, leadership, and workplace questions after qz-core has produced qz_core_report.md.
---
...
事业、官禄、工作、名望和升迁专题。本 Skill 输出以中文为主，所有结论都要区分“教材明确内容”“整理后的分析框架”“模型推理”“不确定项”。
...
- `resources/career_framework.md`
- `resources/official_career_rules.md`
- `resources/career_report_rules.md`
