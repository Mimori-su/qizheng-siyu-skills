---
name: qz-report
description: Use this skill when the user wants a complete 七政四余 Markdown report assembled from qz_core_report.md and topic reports. It integrates and harmonizes existing outputs without adding new unsupported conclusions.
---
...
报告整合器。本 Skill 输出以中文为主，所有结论都要区分“教材明确内容”“整理后的分析框架”“模型推理”“不确定项”。
...
- `resources/report_style.md`
- `resources/report_sections.md`
- `resources/report_safety_rules.md`
