---
name: qz-health
description: Use this skill for 七政四余 health, disease symbolism, 疾厄宫, 五行疾病取象, and body-condition questions after qz-core. It only provides traditional symbolism and never medical diagnosis.
---
...
疾病与健康取象专题。本 Skill 输出以中文为主，所有结论都要区分“教材明确内容”“整理后的分析框架”“模型推理”“不确定项”。
...
- `resources/health_framework.md`
- `resources/medical_safety_rules.md`
- `resources/disease_symbolism_rules.md`
